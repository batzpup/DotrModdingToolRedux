    ...
    public class FastIntro : Patch {
        ...
        static int Name2 =                  0x21E860 - DataAccess.IsoSlusRamOffset;
        static int DeckLeader =             0x21EB98 - DataAccess.IsoSlusRamOffset;
        static int DeckLeader2 =            0x21EAF8 - DataAccess.IsoSlusRamOffset;
        static int PostDeckLeader1 =        0x21EEF4 - DataAccess.IsoSlusRamOffset;
        static int PostDeckLeader2 =        0x21EF44 - DataAccess.IsoSlusRamOffset;
        static int ChooseSides1 =           0x21F280 - DataAccess.IsoSlusRamOffset;
        static int ChooseSides2 =           0x21EF54 - DataAccess.IsoSlusRamOffset;
        static int SkipSeto1 =              0x221ED0 - DataAccess.IsoSlusRamOffset;
        static int SkipSeto2 =              0x221EE4 - DataAccess.IsoSlusRamOffset;
        static int SkipToBoat =             0x21F3E4 - DataAccess.IsoSlusRamOffset;
        static int SkipYugi1 =              0x21F7C8 - DataAccess.IsoSlusRamOffset;
        static int SkipYugi2 =              0x21F624 - DataAccess.IsoSlusRamOffset;
        static int RemoveTutorialOptions1 = 0x219F8C - DataAccess.IsoSlusRamOffset;
        static int RemoveTutorialOptions2 = 0x237EB0 - DataAccess.IsoSlusRamOffset;
       
        static PatchByteSequences Name1 = new PatchByteSequences
        {
          Offset = 0x21E53C - DataAccess.IsoSlusRamOffset,
        ...
        protected override void Apply() {
            ...
            DataAccess.Instance.ApplyPatch(ChooseSides2, new byte[36] { 0x02, 0x00, 0x05, 0x24, 0x01, 0x00, 0x18, 0x24, 0xa8, 0x53, 0x38, 0xa0, 0xed, 0x01, 0x01, 0x3c, 0x34, 0x00, 0x0c, 0x3c, 0x30, 0x00, 0x0e, 0x24, 0x2c, 0xf7, 0x8e, 0xa1, 0xda, 0x10, 0x00, 0x10, 0x6c, 0x53, 0x25, 0xa4 });
